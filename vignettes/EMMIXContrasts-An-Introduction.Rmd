...
```{r, echo=FALSE, cache=TRUE}
library(repmis)
source_data("https://github.com/andrewthomasjones/goldenspikeData/blob/master/
            goldenspike.Rdata?raw=true")
```
## SEQC
...
library(ggplot2)
library(reshape2)
combined <- data.frame(n = seq_along(M), pTrue = pTrue)
